<?php
/*
 * Droppy file uploader
 */

class UploadHandler
{

    protected $options, $CI, $response;
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_url' => $this->get_full_url().'/'.$options['upload_dir_base'],
            'file_id' => null,
            'upload_id' => null,
    ...
    protected function get_upload_path($file_name = null, $version = null) {
        $file_name = $file_name ? $this->options['file_id'] . '-' . $file_name : '';
    ...
    protected function escapeChars($filename)
    {
    ...
    protected function validate($uploaded_file, $file, $error, $index) {
        ...
        $blocked_array = explode(',', $this->options['blocked_file_types']);
        if(in_array($ext, $blocked_array)) {
            $file->error = $this->get_error_message('accept_file_types');
            return false;
        }
    ...
    protected function get_unique_filename($file_path, $name, $size, $type, $error,
        ...
        if($content_range !== null && count($content_range) > 0) {
    ...
    public function generate_response($content, $print_response = true) {
        ...
        if ($print_response) {
            ...
            if($this->get_post_param('redirect') != null) {
