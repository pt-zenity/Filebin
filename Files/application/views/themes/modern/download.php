                ...
                <?php if($data['status'] == 'ready'): ?>
                        <div id="download-form" class="<?php echo (($data['password'] != 'EMPTY' && !empty($data['password']) && $this->session->userdata('download_password') != $upload_id) ? 'password' : '') ?>">
                            <form action="handler/<?php echo (($data['password'] != 'EMPTY' && !empty($data['password']) && $this->session->userdata('download_password') != $upload_id) ? 'password' : 'download') ?>" method="get">
                                ...
                                <div class="top">
                                    ...
                                    <?php if($data['time_expire'] > $data['time']): ?><p class="expire"><?php echo lang('download_will_be_deleted') ?> <?php echo date($settings['date_format'], $data['time_expire']); ?></p><?php endif; ?>
                                </div>
                                ...
                                <?php else: ?>
                                    <div class="upload-message"><?php echo strip_tags($data['message']); ?></div>
                                ...
                                <div class="button-block">
                                    ...
                                    <?php else: ?>
                                        <?php if ($settings['download_report'] == 'true') : ?>
                                            <button class="button is-rounded rounded-side-button" id="report-button"><i class="lni lni-flag"></i></button>
                                        <?php endif; ?>
                        ...
                        <div id="download-started">
                            ...
                            <div class="button-block">
                                ...
                                <button class="button is-rounded rounded-side-button" id="back-button"><i class="lni lni-chevron-left"></i></button>
                                <?php endif; ?>

                                <?php if($settings['lock_page'] == 'upload'): ?>
                                    <button class="button is-info is-rounded" id="done-button" onclick="window.location.reload();" disabled="disabled"><?php echo lang('ok') ?></button>
                                <?php else: ?>
                                    <button class="button is-info is-rounded" id="done-button" onclick="window.location.href = siteUrl;" disabled="disabled"><?php echo lang('ok') ?></button>
                                <?php endif; ?>
                            </div>
                        </div>
                <?php
