                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal style-form" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Mobile logo path</label>
                                <div class="col-sm-10">
                                    <input type="text" name="mobile_logo_path" class="form-control" value="<?php echo $settings['mobile_logo_path']; ?>">
                                    <i>Path to your logo image that is shown on the mobile version of the website</i>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Social meta-tag image</label>
                                <div class="col-sm-10">
                                    <input type="text" name="social_meta_tag_image" class="form-control" value="<?php echo $settings['social_meta_tag_image']; ?>">
                                    <i>Path to your image, this image will be shown when sharing your URL on social media such as Facebook, X and Whatsapp</i>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Require accept terms of service</label>
                                <div class="col-sm-10">
                                    <select class="form-control" name="accept_terms">
                                        <option value="yes">Yes</option>
                                        <option value="no">No</option>
                                    </select>
                                    <i>Require a user to accept the terms of service before using your website</i>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Allow users to report malicious downloads <span class="badge bg-secondary">New!</span></label>
                                <div class="col-sm-10">
                                    <select class="form-control" name="download_report">
                                        <option value="true">Yes</option>
                                        <option value="false">No</option>
                                    </select>
                                    <i>Enable to option to allow users to report downloads. This will show a report button and opens the contact form with a preset subject when clicked. <b>NOTE!</b> The contact form option should be enabled and setup.</i>
                                </div>
                            </div>
                            <script>$('select[name="download_report"]').val("<?php echo $settings['download_report'] ?>");</script>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Session expiration time</label>
                                <div class="col-sm-10">
                                    <input type="number" name="session_expiration" class="form-control" value="<?php echo $settings['session_expiration'] ?>" placeholder="Time in seconds">
                                    <i>The time in seconds after which a session should expire. Each page visit will reset this timer.</i>
                                </div>
                            </div>

                            <div class="mb-3" id="purchase-code">
                            ...
                            <div class="mb-3" id="purchase-code">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="purchase_code" class="form-control" value="<?php echo $settings['purchase_code'] ?>">
                                    <i>Enter your Envato purchase code over here</i>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Custom CSS code <span class="badge bg-secondary">New!</span></label>
                                <div class="col-sm-10">
                                    <textarea name="custom_css_code" class="form-control" style="width: 100%; height: 200px;"><?php echo $settings['custom_css_code'] ?></textarea>
                                    <i>Overwrite or add custom CSS to the frontend pages</i>
                                </div>
                            </div>
