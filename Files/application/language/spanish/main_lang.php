...
$lang = array(
    ...
    'never'                       => "Nunca",
    'add_folders'                 => "Añadir carpeta",
    'or_select_folder'            => "O seleccionar carpeta",

    // Added in update 2.4.8
    'are_you_sure_delete'         => "¿Estás seguro de querer borrar esto?",

    // Added in update 2.5.9
    'report_download_subject'     => "Descarga reportada",

    // Added in update 2.6.4
    'max_recipients_reached'      => "Has alcanzado el número máximo de receptores para esta carga.",

    // Added in update 2.6.9
    'ip_limit'                    => "Has alcanzado tu límite, inténtalo de nuevo más tarde.",
