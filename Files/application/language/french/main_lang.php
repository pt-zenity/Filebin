...
$lang = array(
    ...
    'verify_email_desc'           => "Nous devons savoir que c'est vraiment vous, donc nous avons envoyé un code de vérification à",
    'enter_verify_code'           => "Entrez le code de vérification",
    'verify'                      => "Vérifier",
    'incorrect_verify'            => "Le code de vérification était incorrect!",

// Ajouté dans la mise à jour 2.4.1
    'error'                       => "Erreur",
    'download_browser_unsupported'=> "Votre navigateur ne prend pas en charge le téléchargement in-app, veuillez ouvrir l'URL dans votre navigateur mobile.",

// Ajouté dans la mise à jour 2.4.4
    'unlock_download'             => "Déverrouiller le téléchargement",
    'preview_files'               => "Aperçu des fichiers",

// Ajouté dans la mise à jour 2.4.5
    'copied'                      => "Copié!",

// Ajouté dans la mise à jour 2.4.6
    'login_email'                 => "E-mail",
    'login_password'              => "Mot de passe",
    'never'                       => "Jamais",
    'add_folders'                 => "Ajouter des dossier(s)",
    'or_select_folder'            => "Ou sélectionner un dossier",

// Ajouté dans la mise à jour 2.4.8
    'are_you_sure_delete'         => "Êtes-vous sûr de vouloir supprimer ce fichier?",

    // Added in update 2.5.9
    'report_download_subject'     => "Rapport de téléchargement: ",

    // Added in update 2.6.4
    'max_recipients_reached'      => "Nombre maximum de destinataires atteint pour ce téléchargement.",

    // Added in update 2.6.9
    'ip_limit'                    => "Vous avez atteint votre limite, réessayez plus tard.",
